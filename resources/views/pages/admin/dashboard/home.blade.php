<x-app-layout title="Dashboard">
						...
						<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
						    <div class="card overflow-hidden">
								<div class="card-body">
								    <div class="row">
										<div class="col">
											<h3 class="mb-2 fw-semibold">{{ $kritik }}</h3>
											<p class="text-muted fs-13 mb-0">Total Kritik & Saran</p>
											<p class="text-muted mb-0 mt-2 fs-12">
											    <span class="icn-box text-success fw-semibold fs-13 me-1"></span>
											</p>
										</div>
						...
						<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
							<div class="card overflow-hidden">
								<div class="card-body">
									<div class="row">
										<div class="col">
											<h3 class="mb-2 fw-semibold">{{ $order }}</h3>
											<p class="text-muted fs-13 mb-0">Total Order Produk</p>
											<p class="text-muted mb-0 mt-2 fs-12">
											    <span class="icn-box text-success fw-semibold fs-13 me-1"></span>
											</p>
										</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-6 col-xl-8">
							...
							<div class="card-body">
							  	<div class="sales-stats d-flex">
									<div>
								  		<div class="text-muted fs-13">Total Pendapatan Tahun {{ $year }}
								  	</div>
	...
	<script>
		...
		var chart = new Chart(ctx, {
			...
			datasets: [{
				label: 'Sales',
				data: [{{ $januarySum }}, {{ $februarySum }}, {{ $maretSum }}, {{ $aprilSum }}, {{ $meiSum }}, {{ $juneSum }},{{ $julySum }},{{ $augustSum }},{{ $septemberSum }},{{ $octoberSum }},{{ $novemberSum }},{{ $decemberSum}}],
