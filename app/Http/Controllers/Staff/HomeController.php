...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.staff.dashboard.main', compact('user', 'booking', 'kritik', 'order', 'januarySum','februarySum','maretSum','aprilSum','meiSum','juneSum','julySum','augustSum','septemberSum','octoberSum','novemberSum','decemberSum','year','yeartotal'));
    }
}
